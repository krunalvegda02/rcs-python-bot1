...
#         # Find ONLY pending campaign with botId "bot5"
#         print("🔍 Looking for pending campaign with botId 'bot5'...")
...
#         if not campaign:
#             print("❌ No pending campaign found with botId 'bot5'")
#             client.close()
#             return None
...
def get_campaign_data():
    ...
    try:
        ...
        logger.info("🔍 Looking for pending campaign with botId 'bot5'...")
        campaign = db.campaigns.find_one({
            "botId": "bot5",
            "status": "pending"
        })
        ...
        if not campaign:
            logger.info("❌ No pending campaign found with botId 'bot5'")
            return None
