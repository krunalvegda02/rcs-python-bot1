...
#         # Find ONLY pending campaign with botId "bot4"
#         print("🔍 Looking for pending campaign with botId 'bot4'...")
...
#         if not campaign:
#             print("❌ No pending campaign found with botId 'bot4'")
#             client.close()
#             return None
...
def get_campaign_data():
    ...
    try:
        ...
        logger.info("🔍 Looking for pending campaign with botId 'bot4'...")
        campaign = db.campaigns.find_one({
            "botId": "bot4",
            "status": "pending"
        })
        ...
        if not campaign:
            logger.info("❌ No pending campaign found with botId 'bot4'")
            return None
