...
#         # Find ONLY pending campaign with botId "bot3"
#         print("🔍 Looking for pending campaign with botId 'bot3'...")
...
#         if not campaign:
#             print("❌ No pending campaign found with botId 'bot3'")
#             client.close()
#             return None
...
def get_campaign_data():
    ...
    try:
        ...
        logger.info("🔍 Looking for pending campaign with botId 'bot3'...")
        campaign = db.campaigns.find_one({
            "botId": "bot3",
            "status": "pending"
        })
        ...
        if not campaign:
            logger.info("❌ No pending campaign found with botId 'bot3'")
            return None
